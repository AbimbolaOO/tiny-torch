...
def model_traing_and_validation_loop(Model, n_epochs, save_path, optimizer, train_data_loader, validation_data_loader):
    r"""
        ...
        Example:
            trained_model = model_traing_and_validation_loop(Model, 20, './save_path', train_data_loader, validation_data_loader)
    """
